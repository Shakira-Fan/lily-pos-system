const Hero = () => {
  return (
    <section id="home" className="padding w-full flex xl:flex-row flex-col justify-center min-h-full gap-10 max-container">
        ...
        <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 max-sm:py-0">
