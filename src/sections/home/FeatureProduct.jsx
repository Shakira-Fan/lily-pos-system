  ...
  return (
    <div className="padding-y px-2">
      <div className="flex flex-col justify-center items-center text-center">
        ...
        <p className="text-gray-9f text-base  max-sm:text-sm w-2/5 max-sm:w-full leading-normal pt-4">
          DineTech
          是一套現代化的雲端系統，除了提供簡單易用的介面和操作方式以外，我們也提供
          24/7/365 全年無休的遠端技術支援服務，讓您用的放心！
        </p>
      </div>
      <div className="flex justify-between min-h-full max-sm:flex-col max-sm:items-center bg-primary-bg w-4/5  max-sm:w-[351px] mx-auto mt-4 rounded-2xl">
        ...
        <div>
          <img
            src="imgs/home/img_adv.png"
            alt="img bannder adv"
            className="rounded-r-xl max-sm:rounded-b-xl max-sm:rounded-tr-none max-sm:h-[400px] max-sm:w-[351px] h-[484px] object-cover self-stretch"
          />
        </div>
      </div>
    </div>
