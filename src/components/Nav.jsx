            ...
            <nav className="flex justify-between items-center max-container">
                ...
                <div>
                    <ul className="flex-1 flex justify-center items-center gap-8 max-md:hidden">
                        ...
                        <li>技術支援</li>
                        <li>
                            <button type="button" className="flex justify-center items-center gap-2 bg-gray-e9 rounded-[5px] px-4 py-2">
                                <img src="../icons/ic_message.png" alt="" />
                                預約諮詢
                            </button>
                        </li>
                        <li>
                            <button type="button" className="flex justify-center items-center gap-2 bg-primary-orange text-white rounded-[5px] px-4 py-2">
