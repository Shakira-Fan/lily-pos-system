const PricePlanCard = ({
  ...
  return (
    <div
      className={`bg-secondary-white ${borderColor} border-[3px] rounded-3xl ${
        price === 999 ? "my-8 shadow-xl" : "mt-16"
      } max-sm:my-4`}
    >
      ...
      <div className="py-10 max-sm:py-6 px-9 max-sm:px-[26px]">
        ...
        <div>
          <button className="bg-gray-e9 py-3 max-sm:px-[100px] px-[112px] max-sm:text-sm rounded-[5px] hover:bg-secondary-yellow">
            選擇方案
          </button>
        </div>
      </div>
